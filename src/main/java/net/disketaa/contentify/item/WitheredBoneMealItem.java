...
public class WitheredBoneMealItem extends ContentifyModElements.ModElement {
	@ObjectHolder("contentify:withered_bone_meal")
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("withered_bone_meal");
		}
