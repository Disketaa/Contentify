...
import net.disketaa.contentify.procedures.SakeDrinkingProcedure;
...
public class SakeItem extends ContentifyModElements.ModElement {
	@ObjectHolder("contentify:sake")
	...
	public static class ItemCustom extends Item {
		...
		public ItemStack onItemUseFinish(ItemStack itemstack, World world, LivingEntity entity) {
			...
			SakeDrinkingProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
