...
public class DriedBambooFenceBlock extends ContentifyModElements.ModElement {
	@ObjectHolder("contentify:dried_bamboo_fence")
	public static final Block block = null;

	public DriedBambooFenceBlock(ContentifyModElements instance) {
		super(instance, 10);
	}
