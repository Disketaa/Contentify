...
public class BambooGateBlock extends ContentifyModElements.ModElement {
	@ObjectHolder("contentify:bamboo_gate")
	public static final Block block = null;

	public BambooGateBlock(ContentifyModElements instance) {
		super(instance, 10);
	}
