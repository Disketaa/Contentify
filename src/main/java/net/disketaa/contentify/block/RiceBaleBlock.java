...
public class RiceBaleBlock extends ContentifyModElements.ModElement {
	@ObjectHolder("contentify:rice_block")
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ORGANIC).sound(SoundType.PLANT).hardnessAndResistance(0.5f, 10f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.HOE));
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("rice_block");
		}
