...
public class DriedBambooTrapdoorBlock extends ContentifyModElements.ModElement {
	@ObjectHolder("contentify:dried_bamboo_trapdoor")
	public static final Block block = null;

	public DriedBambooTrapdoorBlock(ContentifyModElements instance) {
		super(instance, 13);
	}
