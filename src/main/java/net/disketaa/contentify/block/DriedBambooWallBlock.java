...
public class DriedBambooWallBlock extends ContentifyModElements.ModElement {
	@ObjectHolder("contentify:dried_bamboo_wall")
	public static final Block block = null;

	public DriedBambooWallBlock(ContentifyModElements instance) {
		super(instance, 6);
	}
	...
	public static class CustomBlock extends PaneBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.SCAFFOLDING).hardnessAndResistance(0.25f, 0.5f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.AXE).notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("dried_bamboo_wall");
		}
