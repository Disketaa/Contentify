...
public class DriedBambooDoorBlock extends ContentifyModElements.ModElement {
	@ObjectHolder("contentify:dried_bamboo_door")
	public static final Block block = null;

	public DriedBambooDoorBlock(ContentifyModElements instance) {
		super(instance, 13);
	}
	...
	public static class CustomBlock extends DoorBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.BAMBOO).hardnessAndResistance(0.5f, 1f).setLightLevel(s -> 0).harvestLevel(0)
