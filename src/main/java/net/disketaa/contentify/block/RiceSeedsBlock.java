...
import net.disketaa.contentify.procedures.RiceSeedsPlacementProcedure;
import net.disketaa.contentify.procedures.RiceGrowingProcedure;
...
public class RiceSeedsBlock extends ContentifyModElements.ModElement {
	@ObjectHolder("contentify:rice_seeds")
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public VoxelShape getShape(BlockState state, IBlockReader world, BlockPos pos, ISelectionContext context) {
			...
			return VoxelShapes.or(makeCuboidShape(0, 6, 0, 16, 16, 16))
		...
		public boolean isValidPosition(BlockState blockstate, IWorldReader worldIn, BlockPos pos) {
			if (worldIn instanceof IWorld) {
				...
				int y = pos.getY();
				int z = pos.getZ();
				return RiceSeedsPlacementProcedure.executeProcedure(Stream
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			RiceGrowingProcedure.executeProcedure(Stream
