...
import net.disketaa.contentify.procedures.DriedBambooBlockSoundsProcedure;
...
public class DriedBambooLogBlock extends ContentifyModElements.ModElement {
	@ObjectHolder("contentify:dried_bamboo_log")
	public static final Block block = null;

	public DriedBambooLogBlock(ContentifyModElements instance) {
		super(instance, 8);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.SCAFFOLDING).hardnessAndResistance(0.5f, 1f).setLightLevel(s -> 0)
					.harvestLevel(0).harvestTool(ToolType.AXE));
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("dried_bamboo_log");
		}
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			DriedBambooBlockSoundsProcedure.executeProcedure(Stream
