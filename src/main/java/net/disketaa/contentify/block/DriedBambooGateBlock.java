...
public class DriedBambooGateBlock extends ContentifyModElements.ModElement {
	@ObjectHolder("contentify:dried_bamboo_gate")
	public static final Block block = null;

	public DriedBambooGateBlock(ContentifyModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("dried_bamboo_gate");
		}
