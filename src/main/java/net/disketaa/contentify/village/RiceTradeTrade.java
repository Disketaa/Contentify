...
import net.disketaa.contentify.item.RicePanicleItem;
...
public class RiceTradeTrade {
	...
	public static void registerTrades(VillagerTradesEvent event) {
		...
		if (event.getType() == VillagerProfession.FARMER) {
			trades.get(1).add(new BasicTrade(new ItemStack(RicePanicleItem.block, (int) (18)), new ItemStack(Items.EMERALD), 14, 2, 0.05f));
		}
	}
}
